...
- `app/experience.tsx`: navigation, service rows, and Lenis/GSAP motion.
...
The navigation and service links work with a keyboard. Animation follows the visitor’s reduced-motion preference. Contact actions use the studio’s existing email, phone, and WhatsApp; there is no form backend.
